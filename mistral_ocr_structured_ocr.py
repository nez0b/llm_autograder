...
Original file is located at
    https://colab.research.google.com/drive/1hAguIP47NVSkX7tmg28RP9ORE9MXMXHo
...
## [OLMOCR](https://olmocr.allenai.org/) (Allen ai)
"""

def jsonl_to_markdown(jsonl_file: str) -> str:
    markdown_output = []
...
markdown_result = jsonl_to_markdown("four.jsonl")

#print(markdown_result)
display(Markdown(markdown_result))

with open("four_olm.md", 'w') as markdown_file:
